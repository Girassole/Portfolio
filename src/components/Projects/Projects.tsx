  ...
  const projectsList: Project[] = [
    {
      ...
      titleKey: "projects.hundredWays.title",
      introKey: "projects.hundredWays.intro",
      tags: ["JavaScript", "PHP", "MySQL", "REST API", "CRUD"],
      githubUrl: "https://github.com/EspeCuenca/proyectoCienManeras",
      videoSrc: "/demo_proyecto.mp4",
      features: [
        { titleKey: "projects.hundredWays.feat1Title", descKey: "projects.hundredWays.feat1Desc" },
        { titleKey: "projects.hundredWays.feat2Title", descKey: "projects.hundredWays.feat2Desc" },
        { titleKey: "projects.hundredWays.feat3Title", descKey: "projects.hundredWays.feat3Title" },
        { titleKey: "projects.hundredWays.feat4Title", descKey: "projects.hundredWays.feat4Desc" },
        { titleKey: "projects.hundredWays.feat5Title", descKey: "projects.hundredWays.feat5Desc" }
      ]
    }
  ];
                      ...
                      {project.features.map((feat, i) => (
                        <div key={i} className="flex items-start space-x-2.5 text-xs">
                          ...
                          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                            <strong className="text-slate-800 dark:text-slate-200 font-semibold font-mono">{t(feat.titleKey)}:</strong> {t(feat.descKey)}
                          </p>
                        </div>
                      ))}
                    </div>
